...
@Transactional(readOnly = true) // Optimizes all read operations (Page queries) by default
public class AuditLogServiceImpl implements AuditLogService {
    ...
    public void createLog(AuditLogRequest request) {
        ...
        // NO NEED to set timestamp here! @CreationTimestamp in the entity handles it.
        auditLogRepository.save(auditLog);
    }

    /**
     * Security / system audits – must survive rollback.
     * Uses REQUIRES_NEW so this transaction commits even if the parent transaction fails.
     */
    @Override
    ...
    /**
     * Business audits – rollback with the main transaction.
     * Uses MANDATORY to enforce that it is only called within an existing active transaction.
     */
    @Override
